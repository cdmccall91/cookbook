...
const pie = new Recipe('Shepherd\'s Pie', [6, 8, 1, .75, 2, 1, 1, 2, .50, .50, 1, 1, .25, .50], ['Blade Meat', 'Blade Meat', 'Onion', 'Beef Base', 'Cabernet', 'Garlic', 'Kitchen B.', 'B. Pepper', 'Pastry Dough', 'Margarine', 'Garn. Garlic', 'Gran. Onion', 'Butter', 'Flour'],['lb', 'oz', 'Each', 'lb', 'oz', 'Tblsp', 'Cups', 'Tblsp', 'lb', 'lb', 'Tblsp', 'lb', 'lb'],'Boil meat until med-well. Slice into .5 inch chunks. Place in pot along with beef base, mushrooms, onions, cabernet, garlic, Kitchen B. black pepper, and 1 gallons of water. Brint to a slow boil and cook until well. In seperate pan, make roux. Mix roux into meat. Grease bottom of hotel pan with margarine and fit pastry dough to pan. Lay meat evenly and bake for 20 minutes on 375')
allRecipes.push(pie);
